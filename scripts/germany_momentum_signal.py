...
TOP_N          = 10   # Backtest without the liquidity filter: 19.1% CAGR,
                      # Sharpe 0.72, MaxDD -39.1%. N=20 scores better on paper
                      # (0.90 / -27.8%) but half its names are not buyable --
                      # four of ranks 11-20 trade under EUR42k/day.
MA_W           = 200
